package com.wyz.web.service.db2;
...
import com.wyz.web.dao.db2.UserMapper2;
...
public class UserService2 extends CrudService<UserMapper2, User>{

	@Autowired
	protected UserMapper2 dao;
